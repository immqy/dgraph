...
//
// FIXME: ... and would also squash any { and: { ... } } into that conjunction.  'or' and
// 'not' cases get built into this in the natural way.
//
// FIXME: more on what the bracketing means
//
